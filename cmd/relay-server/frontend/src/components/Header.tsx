...
export function Header() {
	return (
		<header className="flex items-center justify-between gap-[var(--spacing-3)] rounded-[var(--radius-lg)] border border-border/60 bg-card/80 px-[var(--spacing-4)] py-[var(--spacing-3)] shadow-[var(--shadow-raised)]">
			<div className="flex items-center gap-[var(--spacing-3)]">
				<div className="flex h-10 w-10 items-center justify-center rounded-[var(--radius-2xl)] bg-secondary/80 text-primary shadow-[var(--shadow-raised)]">
					<svg
