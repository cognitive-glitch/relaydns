					...
					<div className="flex flex-col gap-[var(--spacing-3)] md:flex-row md:items-center">
						...
						<div className="flex w-full flex-col gap-[var(--spacing-3)] md:w-auto md:flex-row">
							...
							<Select value={sortBy} onValueChange={onSortByChange}>
								<SelectTrigger className="w-full md:min-w-[11rem]">
						...
						<Button
							...
							variant="ghost"
							size="sm"
							className="w-full justify-between px-[var(--spacing-3)] md:w-auto"
				...
				<CommandList>
					...
					<CommandGroup heading="Status">
						{[
							...
							<CommandItem
								key={item.value}
								onSelect={() => applyStatus(item.value)}
							>
								{item.label}
								{status === item.value && (
