...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.List
    ref={ref}
    className={cn("max-h-72 overflow-y-auto p-1 text-sm", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "flex cursor-pointer select-none items-center gap-2 rounded-md px-2 py-2 text-sm data-[disabled]:opacity-50 data-[disabled]:pointer-events-none aria-selected:bg-muted/60",
      className
    )}
    {...props}
  />
