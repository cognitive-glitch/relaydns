...
import type { Metadata, ServerData } from "@/hooks/useSSRData";
...
function App() {
	...
	return (
		<div className="min-h-screen bg-[hsl(var(--background))] text-foreground">
			<div className="mx-auto flex w-full max-w-6xl flex-col gap-[var(--spacing-4)] px-[var(--spacing-4)] py-[var(--spacing-6)] sm:px-[var(--spacing-5)] lg:px-[var(--spacing-6)]">
				<Header />
				<main className="flex flex-1 flex-col gap-[var(--spacing-4)]">
					...
					<section className="rounded-[var(--radius-xl)] border border-border/50 bg-card p-[var(--spacing-4)] shadow-[var(--shadow-raised)] overflow-visible">
						<div className="grid grid-cols-1 gap-[var(--spacing-4)] md:grid-cols-2 xl:grid-cols-3">
							{paginatedServers.length > 0 ? (
								...
								<div className="col-span-full rounded-[var(--radius-lg)] border border-dashed border-border/60 p-[var(--spacing-6)] text-center">
									<p className="text-[var(--font-size-base)] text-muted-foreground">
